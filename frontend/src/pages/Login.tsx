    ...
    <div className="relative min-h-screen bg-[#050508] flex items-center justify-center overflow-hidden px-4">
      ...
      <div className="w-full max-w-md bg-[#0d0d12]/80 backdrop-blur-xl border border-slate-800/80 p-8 rounded-2xl shadow-2xl shadow-black/50 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-white">Platform Verification</h2>
          <p className="text-sm text-slate-400">Sign in to start tracking attention indexes</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center">
              <label className="text-xs font-semibold text-slate-350">Access Password</label>
              <Link to="/forgot-password" className="text-[10px] text-indigo-400 hover:underline">Forgot password?</Link>
            </div>
            <div className="relative">
        ...
        <div className="text-center text-xs text-slate-500 border-t border-slate-900 pt-4">
          ...
          <Link to="/register" className="text-indigo-400 hover:underline">Request Register Badge</Link>
        </div>
      </div>
    </div>
  );
