...
Generated by CAMS Autonomous Analytics Engine.`;
    ...
    if (ext === "pdf") {
      ...
      doc.setFontSize(10);
      const splitLines = doc.splitTextToSize(reportContent, 180);
      let y = 15;
    ...
    <div className="space-y-6 font-sans text-xs pb-6">
      ...
      <div className="bg-[#0F172A] border border-[#1E293B] p-5 rounded-2xl shadow-lg">
        <div className="flex items-center gap-3">
          <h1 className="text-xl font-black text-white tracking-wide">Reports</h1>
...
<ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip contentStyle={{ backgroundColor: "#070C18", borderColor: "#1E293B", borderRadius: "12px" }} itemStyle={{ color: "#F8FAFC" }} labelStyle={{ color: "#94A3B8" }} formatter={(value, name) => [`${value} Reports`, name]} />
              </PieChart>
            </ResponsiveContainer>
</ComponentErrorBoundary>
